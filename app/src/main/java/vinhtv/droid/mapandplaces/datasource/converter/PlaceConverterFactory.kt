...
class PlaceConverterFactory(gson: Gson): Converter.Factory() {
    ...
    override fun responseBodyConverter(type: Type, annotations: Array<Annotation>, retrofit: Retrofit): Converter<ResponseBody, *>? {
        val wrappedType = object : ParameterizedType {
            ...
            override fun getRawType(): Type = PlaceResponseBody::class.java
        }
        val gsonConverter: Converter<ResponseBody, *>? = gsonConverterFactory.responseBodyConverter(wrappedType, annotations, retrofit)
        return PlaceResponseBodyConverter(gsonConverter as Converter<ResponseBody, PlaceResponseBody<Any>>)
    }
